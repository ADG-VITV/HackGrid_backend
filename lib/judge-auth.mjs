...
/**
 * Whether ID tokens can be verified. A function, not a constant: this module
 * is imported before server.mjs has called loadEnvFile(), so reading the
 * environment at import time would always see it unset.
 */
export function judgeAuthConfigured() {
